                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                SvgPicture.asset("assets/hijri.svg",height: 16,color:Theme.of(context).textTheme.bodyLarge?.color),
                                SizedBox(width: 10,),
                                Text("Hijri Date Adjustment",style: MyTextTheme.smallGCN.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color,)),
                              ],
                            ),
                            SizedBox(height: 5,),
                            Container(
