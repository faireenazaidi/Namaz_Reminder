class CalendarWiseData {
  Timings? timings;
  Date? date;
  Meta? meta;

  CalendarWiseData({this.timings, this.date, this.meta});

  CalendarWiseData.fromJson(Map<String, dynamic> json) {
    timings =
...
class Hijri {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['format'] = this.format;
    data['day'] = this.day;
    if (this.hijriWeekday != null) {
      data['weekday'] = this.hijriWeekday!.toJson();
    }
    if (this.month != null) {
      data['month'] = this.month!.toJson();
    }
