  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          preferredSize: const Size.fromHeight(1.0),
          child: Divider(height: 1.0, color: AppColor.packageGray),
        ),
        leading: InkWell(
          onTap: () {
            Get.back();
        ...
        actions: [
          TextButton(
            ...
            child: SvgPicture.asset("assets/set.svg", height: 25, color: AppColor.greyDark),
          ),
        ],
      ),
      body: Obx(() {
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: Column(
                    children: [
                      Container(
                        color: (controller.notifications[index]['is_read'].toString()) == "false"
                            ? Colors.grey.shade100
                            : Colors.red.shade200,
                        child: ListTile(
                          contentPadding: const EdgeInsets.symmetric(horizontal: 8.0),
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                try {
                                  ...
                                  controller.update();
                                  await controller.readNotificationMessage(controller.notifications[index]['id'].toString());
                                  print("Friend request accepted: ${controller.notifications[index]['id']}");
                                } catch (e) {
                                  print('Error: $e');
                                }
                              },
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                try {
                                  ...
                                  controller.update();
                                  await controller.readNotificationMessage(controller.notifications[index]['id'].toString());
                                  print("Friend request declined: ${controller.notifications[index]['id']}");
                                } catch (e) {
                                  print('Error: $e');
                                }
                              },
